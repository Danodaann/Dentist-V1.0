    ...
    <body>
                        <header>
                            <div class="contenedor">
                                <nav class="menu">
                                    <a href="index.jsp" id="btn-acerca-de">PAGINA DE INICIO</a>
        ...
        No tienes cuenta... <a href="registro.jsp"> Registrarme</a>
                    ...
                    <section class="main">
                        <form action="iniciar" method="post" class="formulario" id="forminicio">
                        <h1 class="formulario__titulo">Accede a tu cuenta</h1>
